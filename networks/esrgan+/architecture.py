...
class SRResNet(nn.Module):
    ...
    def __init__(self, in_nc, out_nc, nf, nb, upscale=4, norm_type='batch', act_type='relu', \
        ...
        Args:
            in_nc (int):                        Number of input channels (e.g., 3 for RGB images).
            out_nc (_type_):                    Number of output channels (usually 3 for RGB).
            nf (_type_):                        Number of filters (feature maps) in the convolutional layers.
            nb (_type_):                        Number of residual blocks.
            upscale (int, optional):            Upscaling factor (e.g., 4 for 4x resolution enhancement).
            norm_type (str, optional):          Type of normalization (e.g., 'batch' for batch normalization)
            act_type (str, optional):           Type of activation function (e.g., 'relu').
            mode (str, optional)                Convolutional mode, typically 'NAC' (Normalization, Activation, Convolution)
            res_scale (int, optional):          Scaling factor for the residual blocks.
            upsample_mode (str, optional):      Method for upsampling ('upconv' or 'pixelshuffle').
        """  
...
class RRDBNet(nn.Module):
    """
    RRDBNet – Residual-in-Residual Dense Blocks Network
    """
